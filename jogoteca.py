...
app.config['MYSQL_HOST'] = '185.201.10.94'
app.config['MYSQL_USER'] = 'u130015149_admin_estudos'
app.config['MYSQL_PASSWORD'] = 'A130099821'
app.config['MYSQL_DB'] = 'u130015149_estudos'
